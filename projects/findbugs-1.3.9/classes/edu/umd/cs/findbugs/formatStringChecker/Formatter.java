...
public final class Formatter {
	...
	public static void check(String format, String... args)
			...
			IllegalFormatConversionException, IllegalFormatException, FormatFlagsConversionMismatchException, MissingFormatArgumentException {
		...
		for (FormatSpecifier fs : parse(format)) {
			...
			case -1: // relative index
				if (last < 0 || last > args.length - 1)
					throw new MissingFormatArgumentException(last, fs.toString());
			...
			case 0: // ordinary index
				...
				if (lasto > args.length - 1)
					throw new MissingFormatArgumentException(lasto, fs.toString());
	...
	private static List<FormatSpecifier> parse(String s) throws FormatFlagsConversionMismatchException {
