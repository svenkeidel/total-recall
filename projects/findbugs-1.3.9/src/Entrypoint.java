...
public class Entrypoint {
    public static void entrypoint(Path jar) {
        try {
            FindBugs2.main(new String[] {
                    ...
                    "/resources/jdk6/charsets.jar:" +
                    "/resources/jdk6/compilefontconfig.jar:" +
                    "/resources/jdk6/dnsns.jar:" +
                    "/resources/jdk6/localedata.jar:" +
                    "/resources/jdk6/pulse-java.jar:" +
                    "/resources/jdk6/sunjce_provider.jar:" +
                    "/resources/jdk6/sunpkcs11.jar:" +
                    "/resources/jdk6/indicim.jar:" +
                    "/resources/jdk6/thaiim.jar:" +
                    "/resources/jdk6/javazic.jar:" +
                    "/resources/jdk6/jce.jar:" +
                    "/resources/jdk6/jsse.jar:" +
                    "/resources/jdk6/management-agent.jar:" +
                    "/resources/jdk6/resources.jar:" +
                    "/resources/jdk6/rhino.jar:" +
                    "/resources/jdk6/rt.jar:" +
                    "/resources/jdk6/US_export_policy.jar:" +
                    "/resources/jdk6/local_policy.jar:" +
                    "/resources/jdk6/dt.jar:" +
                    "/resources/jdk6/jconsole.jar:" +
                    "/resources/jdk6/sa-jdi.jar:" +
                    "/resources/jdk6/tools.jar",
                    jar.toString(),
            });
        } catch (Throwable exc) {
            // Ignore exceptions
    ...
    public static void patchBCELClasses() throws Throwable {
        ...
        for(String clazz : classes) {
            ClassParser parser = new ClassParser("/resources/jdk6/rt.jar", clazz.replace('.', '/')+".class");
