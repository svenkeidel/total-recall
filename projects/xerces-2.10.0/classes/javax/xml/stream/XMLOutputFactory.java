...
public abstract class XMLOutputFactory {
    ...
    private static final String DEFAULT_FACTORY = "com.sun.xml.internal.stream.XMLOutputFactoryImpl";
    ...
    public static XMLInputFactory newInstance(String factoryId,
        ...
        try {
            return (XMLInputFactory) FactoryFinder.find(factoryId, 
                    classLoader, "com.sun.xml.internal.stream.XMLInputFactoryImpl");
        }
        catch (FactoryFinder.ConfigurationError e) {
            throw new FactoryConfigurationError(e.getException(), e.getMessage());
        }
